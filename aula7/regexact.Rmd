...
```
```{r}
download.file(url = "https://raw.githubusercontent.com/STAT545-UBC/STAT545-UBC.github.io/master/gapminderDataFiveYear.txt", destfile = "/home/rstudio/tarefas/bigdata/aula7/gapminderDataFiveYear.txt")
```
```{r input}
library(stringr)
files <- list.files()
...
```{r}
grep("\\bGa|^South|land$", levels(gDat$country), value = TRUE)
```
...
```{r}
download.file(url = "http://stat545-ubc.github.io/block009_dplyr-intro.html", destfile = "/home/rstudio/tarefas/bigdata/aula7/block009_dplyr-intro.html")

download.file(url = "http://stat545-ubc.github.io/block010_dplyr-end-single-table.html", destfile = "/home/rstudio/tarefas/bigdata/aula7/block010_dplyr-end-single-table.html")
```
